...
<div class="rounded-md absolute left-0 top-0 bg-green-50 p-4">
    <div class="flex">
      ...
      <div class="ml-3">
        <p class="text-sm font-medium text-green-800">Successfully Registered</p>
      </div>
...
<div class="flex min-h-full">
    <div class="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24 bg-slate-900">
      <div class="mx-auto w-full max-w-sm lg:w-96">
        <div>
          <!-- <img class="h-10 w-auto" src="" alt="Your Company"> -->
          <h2 class="mt-8 text-2xl font-bold leading-9 tracking-tight text-gray-300">Create your account</h2>
        </div>
          ...
          <div>
            <form action="#" method="POST" class="space-y-6">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center">
                  ...
                  <!-- <div class="absolute inset-0 flex items-center" aria-hidden="true">
                    <div class="pt-500 w-full border-t border-gray-200"></div>
                  </div> -->
                </div>
              </div>
              ...
              <div>
                ...
                <div>
                    <button type="submit" on:click|preventDefault={Success} class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Login</button>
                  </div>
                  {:else}
                  <button type="submit" on:click|preventDefault={Success} class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Register</button>
                {/if}
    ...
    <div class="relative hidden w-0 flex-1 lg:block">
      <img class="absolute inset-0 h-full w-full object-cover" src="https://images.pexels.com/photos/5538003/pexels-photo-5538003.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load" alt="">
    </div>
  </div>
